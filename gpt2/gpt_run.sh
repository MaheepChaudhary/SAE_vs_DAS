...
python main_train.py -a country -tla 61 -method "das masking" -e 10 -t train -idd "country" -bs 16 -wb "True" -n "t(10-0.1)_lr0.01_layer-0" -lr "0.01" -lid 0
python main_train.py -a continent -tla 61 -method "das masking" -e 10 -t train -idd "continent" -bs 16 -wb "True" -n "t(10-0.1)_lr0.01_layer-0" -lr "0.01" -lid 0
